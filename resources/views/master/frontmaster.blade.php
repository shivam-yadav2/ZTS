            ...
            <div class="row gutter-60">
               ...
               <div class="col-12 col-md-6 col-xl-3">
                  <div class="footer-two__widget footer-two__widget--alternate" data-aos="fade-up"
                     ...
                     <div class="footer-two__widget-content">
                        <ul>
                           <li><a href="our-causes.html"><i class="fa-solid fa-arrow-right"></i>Our Causes</a>
                           </li>
               ...
               <div class="row align-items-center gutter-12">
                  <div class="col-12 col-lg-6">
                     <div class="footer-two__copyright-inner text-center text-lg-start">
                        <p>Copyright &copy; <span id="copyrightYear"></span> <a href="index.html">Charifund</a>.
                           All rights
                           reserved.
                        </p>
                     </div>
         ...
         <div class="color-palate-inner">
            <div class="various-color clearfix">
               ...
               <div class="colors-list">
                  <span class="palate default-color active" data-theme-file="{{asset('frontend_assets/css/default-theme.css')}}"></span>
                  <span class="palate blue-color" data-theme-file="{{asset('frontend_assets/css/blue-theme.css')}}"></span>
                  <span class="palate brown-color" data-theme-file="{{asset('frontend_assets/css/brown-theme.css')}}"></span>
                  <span class="palate green-color" data-theme-file="frontend_assets/css/green-theme.css"></span>
                  <span class="palate orange-color" data-theme-file="frontend_assets/css/orange-theme.css"></span>
                  <span class="palate purple-color" data-theme-file="frontend_assets/css/purple-theme.css"></span>
                  <span class="palate teal-color" data-theme-file="frontend_assets/css/teal-theme.css"></span>
                  <span class="palate yellow-color" data-theme-file="frontend_assets/css/yellow-theme.css"></span>
               </div>
            </div>
            <h6>RTL Version</h6>
