        ...
        <div class="col-span-12">
            ...
            <div class="card border-0">
                ...
                @if ($errors->any())
                        ...
                        @endif
                <div class="card-body">
                    <form class="grid grid-cols-12 gap-4" action="{{ url('admin/slider/store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="md:col-span-6 col-span-12">
                            ...
                            <input id="imgInput2"   class="border border-neutral-200 dark:border-neutral-600 w-full rounded-lg text-lg" name="m_img" type="file">
                        </div>
                        ...
                        <div class="md:col-span-6 col-span-12">
                            ...
                            <input type="text" name="sub_text" class="form-control" placeholder="Enter Sub text" required>
                        </div>
                        <div class="md:col-span-6 col-span-12">
