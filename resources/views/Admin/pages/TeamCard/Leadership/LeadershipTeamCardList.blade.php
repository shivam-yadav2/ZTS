    ...
    <div class="col-span-12">
        <div class="card border-0 overflow-hidden w-full">
            <div class="card-header">
                <h6 class="card-title mb-0 text-lg">Leadership Card List</h6>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2">
                                <span class="bg-success-100 dark:bg-success-600/25 
                                             ...
                                             px-4 py-1 rounded-full text-sm"><a href="{{ url('admin/leadership/destroy/'.$data->id) }}"><i class="fa-solid fa-trash"></i></a></span>
                                <span class="bg-success-100 dark:bg-success-600/25 
                                             text-success-600 dark:text-success-400 
                                             px-4 py-1 rounded-full text-sm"><a href="{{ url('admin/leadership/edit/'.$data->id) }}"> <i class="fa-solid fa-pen-to-square"></i></a></span>
                            </td>
