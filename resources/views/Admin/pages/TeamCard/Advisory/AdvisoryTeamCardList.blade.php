                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2">
                                <span class="bg-success-100 dark:bg-success-600/25 
                                             ...
                                             px-4 py-1 rounded-full text-sm"><a href="{{ url('admin/advisory/destroy/'.$data->id) }}"><i class="fa-solid fa-trash"></i></a></span>
                                <span class="bg-success-100 dark:bg-success-600/25 
                                             text-success-600 dark:text-success-400 
                                             px-4 py-1 rounded-full text-sm"><a href="{{ url('admin/advisory/edit/'.$data->id) }}"> <i class="fa-solid fa-pen-to-square"></i></a></span>
                            </td>
