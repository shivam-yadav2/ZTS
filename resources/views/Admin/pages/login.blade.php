            ...
            <div class="lg:max-w-[464px] mx-auto w-full">
                ...
                <form action="#">
                    <div class="icon-field mb-4 relative">
                        ...
                        <input type="email" name="email" class="form-control h-[56px] ps-11 border-neutral-300 bg-neutral-50 dark:bg-dark-2 rounded-xl" placeholder="Email">
                    </div>
                    <div class="relative mb-5">
                        <div class="icon-field">
                            ...
                            <input type="password" class="form-control h-[56px] ps-11 border-neutral-300 bg-neutral-50 dark:bg-dark-2 rounded-xl" id="your-password" placeholder="Password" name="password">
                        </div>
                    ...
                    <div class="mt-8 text-center text-sm">
                        <p class="mb-0">Don't have an account? <a href="{{ url('signup') }}" class="text-primary-600 font-semibold hover:underline">Sign Up</a></p>
                    </div>
