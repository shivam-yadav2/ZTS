        ...
        <div class="col-span-12 lg:col-span-12">
            <div class="card border-0 overflow-hidden">
                <div class="card-header">
                    <h5 class="card-title text-lg mb-0"> Our Journey Muhim List</h5>
                </div>
                <div class="card-body">
                                    ...
                                    <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-600">
                                        ...
                                        <td class="text-center">
                                            <span
                                                ...
                                                <a href="{{ url('admin/ourjourney/muhim/destroy/' . $value->id) }}">
                                                    Delete
                                                </a>
                                            ...
                                            <span
                                                class="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 px-8 py-1.5 rounded-full font-medium text-sm">
                                                <a href="{{ url('admin/ourjourney/muhim/edit/' . $value->id) }}">
                                                    Edit
                                                </a>
