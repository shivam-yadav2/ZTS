        ...
        <div class="col-span-12 lg:col-span-12">
            <div class="card border-0 overflow-hidden">
                <div class="card-header">
                    <h5 class="card-title text-lg mb-0">Our Journey Human Card List</h5>
                </div>
                <div class="card-body">
                                    ...
                                    <tr class="odd:bg-neutral-100 dark:odd:bg-neutral-600">
                                        ...
                                        <td class="text-center">
                                            <span
                                                ...
                                                <a href="{{ url('admin/ourjourney/humanfisrt/destroy/' . $value->id) }}">
                                                    Delete
                                                </a>
                                            ...
                                            <span
                                                ...
                                                <a href="{{ url('admin/ourjourney/humanfisrt/edit/' . $value->id) }}">
                                                    Edit
                                                </a>
