...
<div class="min-h-screen bg-gray-50 dark:bg-neutral-900 py-10 px-4 sm:px-6 lg:px-8">
    <div class="w-full">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-neutral-800 dark:text-neutral-100">Our Journey Human Card List</h1>
        </div>
                    ...
                    <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        <tr class="hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-center space-x-3">
                                <a href="{{ url('admin/ourjourney/humanfirst/edit/' .$value->id) }}"
                                ...
                                <a href="{{ url('admin/ourjourney/humanfirst/destroy/' .$value->id) }}"
