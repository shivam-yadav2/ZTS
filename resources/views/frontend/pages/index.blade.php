...
@section('content')
        ...
        <div class="banner-two__slider swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="banner-two__slider-single">
                        <div class="banner-two__slider-bg"
                            data-background="{{ asset('frontend_assets/images/slide2.jpg') }}">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-md-9  col-lg-7 col-xxl-6">
                ...
                <div class="swiper-slide">
                    <div class="banner-two__slider-single">
                        <div class="banner-two__slider-bg"
                            data-background="{{ asset('frontend_assets/images/slide3.jpg') }}">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-md-9 col-lg-7 col-xxl-6">
                ...
                <div class="swiper-slide">
                    <div class="banner-two__slider-single">
                        <div class="banner-two__slider-bg"
                            data-background="{{ asset('frontend_assets/images/slide4.jpg') }}">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-md-9 col-lg-7 col-xxl-6">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 col-xl-8">
                    <div class="section__header text-center" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h2 class="title-animation">Transform Lives Through Contribution</h2>
    ...
    <section class="help-three difference">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="row gutter-40 mt-60">
                       <div class="col-12 col-lg-5 col-xl-5">
                          <div class="fc-profit__tab-btns">
                             ...
                             <button class="profit__tab-btn " data-target="#profit-five" aria-label="Corporate Gifts Contribute"
                                title="Corporate Gifts Contribute"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="29"
                                   viewBox="0 0 30 29" fill="none">
                                ...
                                </svg> Corporate Gifts Contribute <i class="fa-solid fa-arrow-right"></i></button>
    ...
    <section class="team ff-team pb-0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8">
                    <div class="section__header text-center" data-aos="fade-up" data-aos-duration="1000">
                        <span class="sub-title">Meet our esteemed Standards Advisory Panel who review, inform and guide ZTS
                            through the development of our standards.</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="section-seven-wrapper mb-5" data-aos="fade-up" data-aos-duration="1000"
                        data-aos-delay="200">
                        <h2 class="section-seven-title char-animation">Our counsellors panel</h2>
                        <p class="section-seven-paragraph">communication and utilizes cutting edge logistic planning to
                            get your shipment completed
                            on time. itself founded of backgrounds, which simply.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4">
                    <div class="team-seven-button d-flex justify-content-end mt-40" data-aos="fade-up"
                        data-aos-duration="1000" data-aos-delay="300">
                        <a href="contact-us.html"
                            class="btn-seven-primary btn--primary btn-six-primary d-none d-md-flex fw-medium rounded-5">Check
                            your causes <span><img src="{{ asset('frontend_assets/images/icon/arrow-btn-seven.svg') }}"
                                    alt="arrow"></span></a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="team-seven-wrapper" data-aos="fade-up" data-aos-duration="1000"
                        data-aos-delay="200">
                        <div class="team-seven-thumb position-relative z-1">
                            <a href="team-details.html"><img
                                    src="{{ asset('frontend_assets/images/team/team-seven-thumb1.jpg') }}"
                                    alt="thumb"></a>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="team-seven-wrapper" data-aos="fade-up" data-aos-duration="1000"
                        ...
                        <div class="team-seven-thumb position-relative z-1">
                            <a href="team-details.html"><img
                                    src="{{ asset('frontend_assets/images/team/team-seven-thumb2.jpg') }}"
                                    alt="thumb"></a>
                            <div class="team-seven-wrap">
                                <h4 class="team-seven-title"><a href="team-details.html">Estamina Cordix</a></h4>
                                <div class="team-seven-social">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="team-seven-wrapper" data-aos="fade-up" data-aos-duration="1000"
                        ...
                        <div class="team-seven-thumb position-relative z-1">
                            <a href="team-details.html"><img
                                    src="{{ asset('frontend_assets/images/team/team-seven-thumb3.jpg') }}"
                                    alt="thumb"></a>
                            <div class="team-seven-wrap">
                                <h4 class="team-seven-title"><a href="team-details.html">Estamina Cordix</a></h4>
                                <div class="team-seven-social">
