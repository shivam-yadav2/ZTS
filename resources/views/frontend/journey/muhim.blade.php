            ...
            <div class="gallery__inner">
                <div class="gallery__slider">
                    <div class="gallery__single">
                        <img src="{{asset('frontend_assets/images/gallery/one.png')}}" alt="Image">
                        <a href="index.html">
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    </div>
                    <div class="gallery__single">
                        <img src="{{asset('frontend_assets/images/gallery/two.png')}}" alt="Image">
                        <a href="index.html">
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    </div>
                    <div class="gallery__single">
                        <img src="{{asset('frontend_assets/images/gallery/three.png')}}" alt="Image">
                        <a href="index.html">
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    </div>
                    <div class="gallery__single">
                        <img src="{{asset('frontend_assets/images/gallery/four.png')}}" alt="Image">
                        <a href="index.html">
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    </div>
                    <div class="gallery__single">
                        <img src="{{asset('frontend_assets/images/gallery/five.png')}}" alt="Image">
                        <a href="index.html">
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    </div>
                    <div class="gallery__single">
                        <img src="{{asset('frontend_assets/images/gallery/six.png')}}" alt="Image">
                        <a href="index.html">
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    </div>
                  ...
                  <div class="event__single-wrapper" data-aos="fade-up" data-aos-duration="1000">
                     <div class="event__single van-tilt">
                        <div class="event__single-thumb">
                           <img src="{{asset('frontend_assets/images/event/one.png')}}" alt="Image">
                        </div>
               ...
               <div class="col-12 col-lg-6 col-xl-5">
                  <div class="event__single-wrapper" data-aos="fade-left" data-aos-duration="1000">
                     <div class="event__single event-single-alt van-tilt">
                        <div class="event__single-thumb">
                           <img src="{{asset('frontend_assets/images/event/two.png')}}" alt="Image">
                        </div>
                        <div class="event__content">
                           <span>October 19, 2025</span>
                  ...
                  <div class="event__single-wrapper" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
                     <div class="event__single  event-single-alt van-tilt">
                        <div class="event__single-thumb">
                           <img src="{{asset('frontend_assets/images/event/three.png')}}" alt="Image">
                        </div>
                        <div class="event__content">
                           <span>October 19, 2025</span>
                           <h4><a href="event-details.html">Unity in Giving Community
